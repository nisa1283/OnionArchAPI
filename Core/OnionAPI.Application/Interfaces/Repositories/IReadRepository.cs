...
namespace OnionAPI.Application.Interfaces.Repositories
{
    ...
    {
        Task<IList<T>> GetAllAsnyc(Expression<Func<T, bool>> predicate = null,
        ...
        Task<T> GetAsnyc(Expression<Func<T, bool>> predicate, Func<IQueryable<T>, IIncludableQueryable<T, object>>? include = null, bool enableTracking = false);
